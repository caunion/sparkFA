...
$SPARK_HOME/bin/spark-submit --class org.qcri.sparkpca.SparkPCA --master $master_url /root/sparkFA/spca-spark/target/sparkPCA-1.0.jar -i /root/sparkFA/spca-spark/input/data_sig -o /root/sparkFA/spca-spark/output -rows 1000 -cols 7 -pcs 3 -errSampleRate 1 -maxIter=200
